...
mac:
	...
	mkdir -p macOS/TPad.app/Contents/{MacOS,Resources}
	cp .build/release/TPadServer macOS/TPad.app/Contents/MacOS/
	cp macOS/AppIcon.icns macOS/TPad.app/Contents/Resources/ 2>/dev/null || true
	...
	@echo '<key>CFBundleDisplayName</key><string>T-Pad</string>' >> macOS/TPad.app/Contents/Info.plist
	@echo '<key>CFBundlePackageType</key><string>APPL</string>' >> macOS/TPad.app/Contents/Info.plist
	@echo '<key>CFBundleVersion</key><string>1.0.0</string>' >> macOS/TPad.app/Contents/Info.plist
	@echo '<key>CFBundleShortVersionString</key><string>1.0.0</string>' >> macOS/TPad.app/Contents/Info.plist
	@echo '<key>CFBundleIconFile</key><string>AppIcon</string>' >> macOS/TPad.app/Contents/Info.plist
	...
	@echo '<key>NSHighResolutionCapable</key><true/>' >> macOS/TPad.app/Contents/Info.plist
